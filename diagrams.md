...
<img src="images/sequence-login-gameplay-session.svg" alt="Sequence diagram: login to gameplay session" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-login-gameplay-session.svg)

<h3 id="connection-lost-fallback-layer">Connection lost / fallback layer</h3>

<img src="images/sequence-connection-lost-fallback-layer.svg" alt="Sequence diagram: connection lost and fallback layer" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />
...
<img src="images/sequence-client-reconnect-resync.svg" alt="Sequence diagram: client reconnect and state resync" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-client-reconnect-resync.svg)

<h3 id="layer-migration">Layer migration</h3>

<img src="images/sequence-layer-migration.svg" alt="Sequence diagram: layer migration" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-layer-migration.svg)

<h3 id="layer-merge-remove-pod">Layer merge / remove pod</h3>

<img src="images/sequence-layer-merge-remove-pod.svg" alt="Sequence diagram: layer merge and remove pod" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-layer-merge-remove-pod.svg)

<h3 id="world-event-event-bus">World event / Event Bus</h3>

<img src="images/sequence-world-event-eventbus.svg" alt="Sequence diagram: world event and Event Bus" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-world-event-eventbus.svg)

<h3 id="metrics-warmup-scaling">Metrics / warmup / scaling</h3>

<img src="images/sequence-metrics-warmup-scaling.svg" alt="Sequence diagram: metrics, warmup, scaling" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />
...
<img src="images/sequence-warmup-configuration-techadmin.svg" alt="Sequence diagram: Tech-Admin warmup configuration" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-warmup-configuration-techadmin.svg)

<h3 id="switch-simulation-target">Switch simulation target</h3>

<img src="images/sequence-switch-simulation-target.svg" alt="Sequence diagram: switch simulation target" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-switch-simulation-target.svg)

<h3 id="dungeon-instance-entry">Dungeon instance entry</h3>

<img src="images/sequence-dungeon-instance-entry.svg" alt="Sequence diagram: dungeon instance entry" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />

[Raw SVG](images/sequence-dungeon-instance-entry.svg)

<h3 id="dungeon-exit-open-world">Dungeon exit / open world</h3>

<img src="images/sequence-dungeon-exit-open-world.svg" alt="Sequence diagram: dungeon exit to open world" width="2400" style="max-width: 100%; height: auto; background-color: #ffffff;" />
